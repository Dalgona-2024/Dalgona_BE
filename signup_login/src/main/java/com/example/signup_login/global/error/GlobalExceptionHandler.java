package com.example.signup_login.global.error;
...
public class GlobalExceptionHandler {
    @ExceptionHandler(DalgonaException.class)
    public ResponseEntity<ErrorResponse> handleGlobal(DalgonaException e) {
